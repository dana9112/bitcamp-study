/*
 데이터 -> 중복 -> 쪼개 -> 관계 -> 부모/자식 관계 -> FK -> RDBMS
*/

# FK(Foreign Key)
- 데이터 중복을 막기 위해서쪼개는데 그때
...
create table test2(
  ...
  filepath varchar(255) not null, /* 파일시스템에 저장된 첨부파일의 경로만 저장함, 파일까지 같이 저장되는것은 아님 */
