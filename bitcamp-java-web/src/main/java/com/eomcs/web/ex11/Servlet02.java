...
public class Servlet02 extends HttpServlet {
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response)
    ...
    // 세션 아이디 보내기
    // => 서버로부터 세션 아이디 쿠기를 받은 세션 아이디는
    // 웹 브라우저가 해당 서버에 요청할 때마다 세션 아이디 쿠키를 보낸다.
    // => HTTP 요청 프로토콜
    ...
    // .....
    // Cookie: JSESSIONID=65DB1DE4A8D742CE8B734B76B1B2C716 <--- 세션아이디
    ...
    // ... => 응답 프로토콜에 새로 생성한 HttpSession 객체의 세션ID를 보낸다.
