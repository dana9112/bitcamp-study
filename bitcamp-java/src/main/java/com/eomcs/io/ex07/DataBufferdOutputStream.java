...
public class DataBufferdOutputStream extends BufferedOutputStream {

  public DataBufferdOutputStream(String filename) throws Exception {
    super(filename); // 설정 안해주면 수퍼 생성자의 디폴트 값을 출력함.
  }
