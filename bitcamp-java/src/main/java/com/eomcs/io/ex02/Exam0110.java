...
public class Exam0110 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // - 이번 예제에서 다루는 FileOuputStream 클래스에도 close()가 있다.
...
// - 바이너리 파일을 편집하려면 전용 해당 파일 포맷을 이해하는 전용 프로그램이 필요하다.
//  
// 2) 텍스트 파일
