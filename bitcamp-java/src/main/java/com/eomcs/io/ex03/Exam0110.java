...
public class Exam0110 {
  public static void main(String[] args) throws Exception {
    ...
    //    JVM에 설정된 기본 문자코드표의 값으로 변환하여 파일에 쓴다.
    ...
    //
    //
    // *=> 이 예제를 이클립스에서 실행한다면 다음 4바이트 값을 출력하면 
    //    앞의 2바이트는 버리고, 
    ...
    // - 앞의 2바이트(7a6b)는 버린다.
    // - 뒤의 2바이트(ac00)은 UTF-8 코드 값으로 변환되어 파일에 쓴다.
    
    // UCS2에서 영어 A는 0041dlek.
    // 출력하면, UTF-8 코드 값(41)이 출력 된다.
    out.write(0x7a5f0041);
    // - 앞의 2바이트(7a5f)는 버린다.
    // - 뒤의 2바이트는 UTF-8(41) 코드 값으로 변환되어 파일에 쓴다. 
