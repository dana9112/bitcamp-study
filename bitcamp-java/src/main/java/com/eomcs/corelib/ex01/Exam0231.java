...
public class Exam0231 {
  public static void main(String[] args) {
    ...
    // 값이 같더라도 인스턴스가 별도로 따로 생성되기 때문에, 
    Integer obj3 = Integer.valueOf(100); // Heap에 인스턴스 생성 
    Integer obj4 = Integer.valueOf(100); // Heap에 인스턴스 생성 
    
    // 다음과 같이 == 연산자를 사용하여 비교하면 안된다.
    System.out.println(obj3 == obj4);
    
    // String 클래스의 경우처럼
    // Integer 클래스가 오버라딩한 equals()를 호출해야 한다.
