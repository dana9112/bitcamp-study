...
// 1) mvnrepository.com 또는 seatch.maven.org 에서
...
public class Exam0110 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    CloseableHttpClient httpClient = HttpClients.createDefault/* 팩토리메소드 */();
    ...
    if (entity != null) {
      ...
      System.out.printf("응답 데이터 크기 => %d\n", entity.getContentLength()); // 데이터 크기는 바이트 값으로 나옴
      ...
      // => 이 부분을 대신 해주는 도우미 클래스가 있다. (EntityUtils)
