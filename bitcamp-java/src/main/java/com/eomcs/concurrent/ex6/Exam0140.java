  ...
  public static void main(String[] args) {
    ...
    class MyThread extends Thread {
      ...
      public void setCount(int count) {
        ...
        synchronized (this) {
          // synchronized 블록에 객체의 사용을 기다리는 스레드에게
          // 작업을 시작할 것을 알린다.
          notify();
        ...
        synchronized (this) {
          ...
          try {
            while (true) {
              ...
              // wait()는 반드시 동기화 영역안에서 호출해야 한다.
              // 동기화 영역?
              // => synchronize로 선언된 메서드
              // => synchronize로 묶인 블록
              //
              // 기다림을 끝내는 방법?
              // => notify()를 통해 기다림이 끝났음을 알림받아야 한다.
