...
public class Exam61 {
  public static void main(String[] args) {
   ...
   // 배열 사용
    ...
    // 물론, JVM을 종료하면 당연히 JVM이 사용하던 모든 메모리는 OS에 반납되기 떄문에 가비지 또한 반납될 것이다. 
    ...
    //인스터스 생성과 동시에 값을 지정할 때는 배열 개수를 지정하면 안된다
    //int[] arr6 = new int[]{100, 90, 80}; //컴파일 오류
    
    // 배열 선언과 동시에 인스턴스를 초기화시킬때는 new int[]를 생성할 수 있다.
    int[] arr7 = {100,90,80};


    // 레퍼런스 생성한 다음에 값을 초기화시킬때는 new int[] 생략할 수 없다. 
    int[] arr8;
    //arr9 = {100,90,80};
