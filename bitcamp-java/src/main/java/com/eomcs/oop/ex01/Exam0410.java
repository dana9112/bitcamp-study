...
//   > javac -encoding UTF-8 -d bin src/main/java/com/eomcs/oop/ex01/Exam0410.java
// - 이유?
...
// 
// 방법2) Score 클래스의 소스 파일이 있다면 소스 파일의 위치를 알려줘라.  (class파일이 없을 경우 에러가 뜨기 때문에 소스파일로 알려주는 방법이 있음)
