...
public class Exam0113 {
  ...
  public static void main(String[] args) {
    ...
    // 메서드를 사용할때 그 타입 전용 클래스인 것 처럼 쓰면 된다.
