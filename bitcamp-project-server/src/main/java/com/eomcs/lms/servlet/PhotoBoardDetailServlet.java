...
public class PhotoBoardDetailServlet extends HttpServlet {
  ...
  @Override
  protected void doGet(HttpServletRequest request, HttpServletResponse responst)
      throws ServletException, IOException {
    try {
      responst.setContentType("text/html;charset=UTF-8");
      PrintWriter out = responst.getWriter();
