...
//
public abstract class AbstractList1_2<E> implements List<E> {
  protected int size;
 ...
 ## 클래스 멤버:
  ...
  public Iterator<E> iterator() {
    ...
    return new Iterator<E>() { // 얘는 수퍼클래스 아니면 인터페이스다. () -> 생성자는 Object의 디폴트 값을 받는다.
      ...
      { 
        ...
        this.list = (List<E>) AbstractList1_2.this;
      }
