...
public class BoardHandler {
  ...
  // 인스턴스 필드 ( = non -static field = instance field, 개별관리 할 수 있는 것)
  ...
  // 클래스 필드 (로딩될때 자동으로 만들어 지는 것 static field = class field)
  ...
  //    인스턴스 주소.메서드명();
  // => 이렇게 인스턴스의 변수값을 다루는 메서드는 "연산자(operation)"라 부를 수 있다.
